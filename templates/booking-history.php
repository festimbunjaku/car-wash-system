...
<section class="container mt-8 px-4 mx-auto w-full h-full">
    <div class="flex items-center gap-x-3">
        <h2 class="text-lg font-medium text-gray-800">Reservation History</h2>
        <span class="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full"><?= count($bookings) ?>  Reservations</span>
    </div>
